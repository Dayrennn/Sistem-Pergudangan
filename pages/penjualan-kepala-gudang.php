...
function flashMessage($message, $type = 'success') {
    ...
    header("Location: penjualan-kepala-gudang.php");
    exit;
}
...
if ((!empty($data_pelanggan) && !empty($data_pesanan)) || 
    ...
    if (!empty($data_pelanggan) && !empty($data_pesanan)) {
        ...
        // Data dari form penjualan-kepala-gudang.php (saat pesanan dibuat dari form)
...
<div class="container">
    ...
    <aside class="sidebar">
        <ul>
            ...
            <hr style="margin-top: 35px; margin-bottom: 30px; border: none; height: 2px; background-color:rgb(145, 145, 145);">
            <li><a href="../main/index-kepala-gudang.php"><i class='bx bx-home-alt-2'></i><span>Dashboard</span></a></li>
            <li><a href="barang-kepala-gudang.php"><i class='bx bx-package'></i><span>Data Barang</span></a></li>
            <li><a href="penjualan-kepala-gudang.php"><i class='bx bx-cart'></i><span>Data Penjualan</span></a></li>
            <li><a href="supplier-kepala-gudang.php"><i class='bx bx-store-alt'></i><span>Data Supplier</span></a></li>
            <li><a href="penjadwalan-pembelian-kepala-gudang.php"><i class='bx bx-user' ></i></i><span>Penjadwalan Pembelian</span></a></li>
            <li><a href="data-pembelian-kepala-gudang.php"><i class='bx bx-dollar'></i><span>Data Pembelian</span></a></li>
            <li>
    ...
    <div class="beranda">
        ...
        <div class="search-container">
            <form method="GET" action="penjualan-kepala-gudang.php">
