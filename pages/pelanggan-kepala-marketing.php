...
if (!function_exists('showError')) {
    function showError($conn, $stmt = null, $message = "Terjadi kesalahan.") {
        ...
        if (!isset($_SERVER['HTTP_X_REQUESTED_WITH']) || strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) !== 'xmlhttprequest') {
            header("Location: pelanggan-kepala-marketing.php");
            exit;
        }
...
$query_pelanggan = mysqli_query($conn, "
    ...
    p.email,
    p.alamat,
    GROUP_CONCAT(pj.nama_produk SEPARATOR ', ') AS produk,
    GROUP_CONCAT(ps.jumlah_pesan SEPARATOR ', ') AS jumlah,
    GROUP_CONCAT(ps.barang_id SEPARATOR ', ') AS barang_ids,
    GROUP_CONCAT(pj.harga_jual SEPARATOR ', ') AS harga_satuan,
    GROUP_CONCAT(ps.total_harga SEPARATOR ', ') AS total_hargas,
    GROUP_CONCAT(ps.tanggal_pesan SEPARATOR ', ') AS tanggal_pesanan,
    GROUP_CONCAT(ps.status SEPARATOR ', ') AS status_pesanan
FROM pelanggan p
...
<div class="container">
    ...
    <div class="beranda">
        ...
        <div class="search-container">
            ...
            <form method="GET" action="pelanggan-kepala-marketing.php">
...
<div id="modalPelanggan" class="modal">
    <div class="modal-content">
        ...
        <form id="formPelanggan" method="POST" action="pelanggan-kepala-marketing.php">
