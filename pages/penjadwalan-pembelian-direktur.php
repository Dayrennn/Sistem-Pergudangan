...
// Jika penjadwalan-pembelian-direktur.php ada di 'pages/', dan koneksi.php ada di root,
...
function getBarangBySupplier(supplierId, targetSelect, selectedBarang = '') {
    ...
    fetch(`penjadwalan-pembelian-direktur.php?ajax=get_barang&supplier_id=${supplierId}`)
