...
// Jika penjadwalan-pembelian-kepala-gudang.php ada di 'pages/', dan koneksi.php ada di root,
...
function getBarangBySupplier(supplierId, targetSelect, selectedBarang = '') {
    ...
    fetch(`penjadwalan-pembelian-kepala-gudang.php?ajax=get_barang&supplier_id=${supplierId}`)
