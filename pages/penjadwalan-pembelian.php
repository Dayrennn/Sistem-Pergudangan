...
// Jika penjadwalan-pembelian.php ada di 'pages/', dan koneksi.php ada di root,
...
<div class="container">
    ...
    <aside class="sidebar" id="sidebar">
        <ul>
            ...
            <li><a href="penjadwalan-pembelian.php"><i class='bx bx-user'></i><span>Penjadwalan Pembelian</span></a></li>
