...
function flashMessage($message, $type = 'success') {
    ...
    header("Location: penjualan-staff-gudang.php");
    exit;
}
...
if ((!empty($data_pelanggan) && !empty($data_pesanan)) || 
    ...
    if (!empty($data_pelanggan) && !empty($data_pesanan)) {
        ...
        // Data dari form penjualan-staff-gudang.php (saat pesanan dibuat dari form)
...
<div class="container">
    ...
    <div class="beranda">
        ...
        <div class="search-container">
            <form method="GET" action="penjualan-staff-gudang.php">
