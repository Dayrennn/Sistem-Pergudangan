...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update_pengeluaran'])) {
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        echo "<script>window.location.href='data-keuangan-komisaris.php';</script>";
    } else {
...
<div class="container">
    ...
    <aside class="sidebar">
        <ul>
            ...
            <hr style="margin-top: 35px; margin-bottom: 30px; border: none; height: 2px; background-color:rgb(145, 145, 145);">
            <li><a href="../main/index-komisaris.php"><i class='bx bx-user' ></i></i><span>Dashboard</span></a></li>
            <li><a href="data-keuangan-komisaris.php"><i class='bx bx-user' ></i></i><span>Data Keuangan</span></a></li>
