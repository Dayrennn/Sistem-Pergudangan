...
if (!function_exists('showError')) {
    function showError($conn, $stmt = null, $message = "Terjadi kesalahan.") {
        ...
        if (!isset($_SERVER['HTTP_X_REQUESTED_WITH']) || strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) !== 'xmlhttprequest') {
            header("Location: pelanggan-staff-gudang.php");
            exit;
        }
...
<div class="container">
    ...
    <div class="beranda">
        ...
        <div class="search-container">
            ...
            <form method="GET" action="pelanggan-staff-gudang.php">
...
<div id="modalPelanggan" class="modal">
    <div class="modal-content">
        ...
        <form id="formPelanggan" method="POST" action="pelanggan-staff-gudang.php">
...
<div id="modalHapus" class="modal">
    <div class="modal-content">
        ...
        <form id="formHapusPelanggan" method="POST" action="hapus_pelanggan-staff-gudang.php">
