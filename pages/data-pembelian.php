...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['hapus_supplier'])) {
    ...
    mysqli_query($conn, "DELETE FROM supplier WHERE id='$id'"); // Menggunakan 'id' bukan 'supplier_id' untuk hapus
    header("Location: data-pembelian.php");
    exit;
}
...
<div class="container">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <ul>
            ...
            <li><a href="data-pembelian.php" class="active"><i class='bx bx-dollar'></i><span>Data Pembelian</span></a></li>
