...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['add_barang_keluar'])) {
        ...
        $keterangan_input = $_POST['keterangan'];
    ...
    <div class="container">
        <aside class="sidebar" id="sidebar">
                <ul>
                    ...
                    <li><a href="supplier-kepala-gudang.php"><i class='bx bx-cart'></i><span>Data Supplier</span></a></li>
                    <li><a href="penjadwalan-pembelian-kepala-gudang.php"><i class='bx bx-user' ></i></i><span>Penjadwalan Pembelian</span></a></li>
                    <li><a href="data-pembelian-kepala-gudang.php"><i class='bx bx-user' ></i></i><span>Data Pembelian</span></a></li>
                    <li>
