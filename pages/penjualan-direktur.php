...
function flashMessage($message, $type = 'success') {
    ...
    header("Location: penjualan-direktur.php");
    exit;
}
...
if ((!empty($data_pelanggan) && !empty($data_pesanan)) || 
    ...
    if (!empty($data_pelanggan) && !empty($data_pesanan)) {
        ...
        // Data dari form penjualan-direktur.php (saat pesanan dibuat dari form)
...
<div class="container">
    ...
    <div class="beranda">
        ...
        <div class="search-container">
            <form method="GET" action="penjualan-direktur.php">
...
<script>
    // Di dalam file JS yang relevan (misalnya javascript/penjualan.js atau di <script> di penjualan-direktur.php)

// Contoh di javascript/penjualan.js (atau di <script> di penjualan-direktur.php)
    ...
    document.addEventListener('click', function(event) {
        ...
        if (event.target.classList.contains('btn-hapus-penjadwalan')) {
            ...
            if (confirm('Apakah Anda yakin ingin menghapus data penjadwalan pembelian ini?')) {
                fetch(`hapus_penjualan-direktur.php?id=${idToDelete}`, { // Panggil hapus_penjualan-direktur.php dengan ID via GET
                    method: 'GET', // Sesuai dengan hapus_penjualan-direktur.php yang pakai $_GET
                })
                .then(response => {
                    if (!response.ok) {
