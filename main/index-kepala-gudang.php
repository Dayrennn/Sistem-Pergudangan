...
<head>
    ...
    <link rel="stylesheet" href="../css/index-kepala-gudang.css">
        ...
        <div class="container">
            ...
            <aside class="sidebar" id="sidebar">
                ...
                <ul>
                    ...
                    <hr style="margin-top: 35px; margin-bottom: 30px; border: none; height: 2px; background-color:rgb(145, 145, 145);">
                    <li><a href="index-kepala-gudang.php"><i class='bx bx-home-alt-2'></i><span>Dashboard</span></a></li>
                    <li><a href="../pages/barang-kepala-gudang.php"><i class='bx bx-package'></i><span>Data Barang</span></a></li>
                    <li><a href="../pages/penjualan-kepala-gudang.php"><i class='bx bx-cart'></i><span>Data Penjualan</span></a></li>
                    <li><a href="../pages/supplier-kepala-gudang.php"><i class='bx bx-cart'></i><span>Data Supplier</span></a></li>
                    <li><a href="../pages/penjadwalan-pembelian-kepala-gudang.php"><i class='bx bx-user' ></i></i><span>Penjadwalan Pembelian</span></a></li>
                    <li><a href="../pages/data-pembelian-kepala-gudang.php"><i class='bx bx-user' ></i></i><span>Data Pembelian</span></a></li>
                    <li>
                    ...
                    <div class="data-grafik-container">
                        ...
                        <div>
                            ...
                            <table class="data-table" style="width: 660px; margin: 15px;">
                                ...
                                <tbody>
                                    <?php
                                    $query_produk_jadi = mysqli_query($conn, "SELECT * FROM produk_jadi") or die("Error produk_jadi: " . mysqli_error($conn));
                            ...
                            <a href="pages/barang-kepala-gudang.php" style="margin-left:20px;">Lihat Selengkapnya</a>
                        </div>
                    </div>
                ...
                <div class="data-table-container">
                    ...
                    <table class="data-table">
                        ...
                        <tbody id="jadwalTableBody">
                            <?php
                            // Asumsi Anda memiliki variabel $jadwal yang berisi data untuk tabel ini
                            // Anda perlu menambahkan query untuk $jadwal di bagian atas file PHP Anda
                            // Contoh: $jadwal = mysqli_query($conn, "SELECT * FROM penjadwalan_pembelian");
                            if (isset($jadwal)) {
                                ...
                                <tr><td colspan="6">Data penjadwalan pembelian tidak tersedia.</td></tr>
                            <?php } ?>
                        </tbody>
                    </table>
                </div>
