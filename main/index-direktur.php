...
<head>
    ...
    <link rel="stylesheet" href="../css/index-direktur.css">
        ...
        <div class="container">
            ...
            <aside class="sidebar" id="sidebar">
                ...
                <ul>
                    ...
                    <hr style="margin-top: 35px; margin-bottom: 30px; border: none; height: 2px; background-color:rgb(145, 145, 145);">
                    <li><a href="index-direktur.php"><i class='bx bx-home-alt-2'></i><span>Dashboard</span></a></li>
                    <li><a href="../pages/barang-direktur.php"><i class='bx bx-package'></i><span>Data Barang</span></a></li>
                    <li><a href="../pages/penjualan-direktur.php"><i class='bx bx-cart'></i><span>Data Penjualan</span></a></li>
                    <li><a href="../pages/penjadwalan-pembelian-direktur.php"><i class='bx bx-user' ></i></i><span>Penjadwalan Pembelian</span></a></li>
                    <li><a href="../pages/data-pembelian-direktur.php"><i class='bx bx-dollar'></i><span>Data Pembelian</span></a></li>
                    <li>
                ...
                <div class="box">
                    <div class="data-grafik-container">
                        ...
                        <div style="flex: 1;">
                            ...
                            <a href="pages/barang-direktur.php" style="margin-left:20px;">Lihat Selengkapnya</a>
                        </div>
                    </div>
                    <div class="data-jual-container">
                            <div style="flex: 1;">
                                ...
                                <a href="pages/penjadwalan-pembelian-direktur.php" style="margin-left:20px;">Lihat Selengkapnya</a>
                            </div>
                        </div>
                    </div>
