document.addEventListener("DOMContentLoaded", function () {
  ...
  const modalEditStatus = document.getElementById("modalEditStatus"); // NEW: Modal Edit Status (jika digunakan di data-keuangan.php)
  ...
  $("#confirmDelete").click(function () {
    if (pengeluaranToDeleteId) {
      ...
      window.location.href =
        "data-keuangan.php?hapus_pengeluaran=" + pengeluaranToDeleteId;
    }
  });
  ...
  $(document).on("click", ".edit-hutang-btn", function () {
    ...
    $.ajax({
      url: "data-keuangan.php", // Pastikan ini mengarah ke file yang benar
      method: "GET",
  ...
  $("#confirmDeleteHutang").click(function () {
    if (hutangToDeleteId) {
      window.location.href =
        "data-keuangan.php?hapus_hutang=" + hutangToDeleteId;
    }
  });
  ...
  // `hasReminders` diharapkan di-inject oleh PHP di HTML (seperti yang ditunjukkan di data-keuangan.php di atas)
  ...
  // NEW FUNCTIONS for "Edit Status" modal (Jika digunakan di data-keuangan.php)
  // Pastikan modalEditStatus HTML ada di data-keuangan.php jika Anda menggunakan ini
  window.editStatus = function (id, currentStatus) {
    if (modalEditStatus) {
      ...
      console.warn(
        "Modal 'modalEditStatus' not found. Ensure it's in data-keuangan.php HTML."
      );
    }
  };
