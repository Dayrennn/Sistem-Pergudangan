document.addEventListener("DOMContentLoaded", function () {
  ...
  formPelanggan.addEventListener("submit", function (e) {
    ...
    // Tambahkan header X-Requested-With untuk membedakan permintaan AJAX di PHP
    formData.append("simpan_pelanggan", "1"); // Pastikan ini ada untuk logika PHP

    fetch("../pages/pelanggan-kepala-marketing.php", {
      method: "POST",
      body: formData,
      headers: {
  ...
  formHapusPelanggan.addEventListener("submit", function (e) {
    ...
    fetch("../pages/hapus_pelanggan.php", {
      method: "POST",
      body: formData,
    })
      .then((response) => response.text()) // Asumsi hapus_../pages/pelanggan-kepala-marketing.php masih mengembalikan teks biasa
      .then((data) => {
        showCustomAlert(
